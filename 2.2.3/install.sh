...
if [ -n "${WAVEPEEK_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.2.3"
elif [ -n "${WAVEPEEK_INSTALLER_GITHUB_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$WAVEPEEK_INSTALLER_GITHUB_BASE_URL"
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.2.3"
else
    ARTIFACT_DOWNLOAD_URLS="https://github.com/kleverhq/wavepeek/releases/download/v2.2.3"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.32.0"},"source":{"app_name":"wavepeek","name":"wavepeek","owner":"kleverhq","release_type":"github"},"version":"2.2.3"}
EORECEIPT
...
The installer for wavepeek 2.2.3

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/kleverhq/wavepeek/releases/download/v2.2.3
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "wavepeek-aarch64-apple-darwin.tar.gz")
            ...
            _checksum_value="764a6b413dfb9bfce4f0bf9f5b2f77c476d646feea26c9d4e18590baee4e49e5"
            _bins="wavepeek"
        ...
        "wavepeek-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="254ba9bd7c72343c482cbbb1920fe89a7bb6345bcca695b7becba463849407a6"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="ac6510391449f5aa994ab42d71a133acfe50ba4b3553d2424a48bd2f08b9146a"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="5609cdcdf1af51eb4590a60291b3a012781f503babb1c6f099e41d441594382e"
            _bins="wavepeek.exe"
        ...
        "wavepeek-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="2eafcd37b6cef74eab6a2340d61dad530afc436baecace5d5bd6e8f46c13f704"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
