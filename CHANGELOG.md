...
### Fixed
- Updated waveform parsing to accept newer Verilator FST `PACK` and `ARRAY` hierarchy attributes and reconstruct producer-split packed vectors as single signals ([issue #73](https://github.com/kleverhq/wavepeek/issues/73)).
