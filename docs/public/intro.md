...
5. **Stable machine contracts.** JSON and JSONL shapes are documented in `reference/machine-output` and covered by direct runtime tests, while human-readable output stays intentionally more flexible.
