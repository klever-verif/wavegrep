...
For several generic source types, or for a reusable AHB, APB, ATB, AXI, or AXI-Stream profile/mapping setup, write a source file and pass `--source`. See `commands/extract` and command help for source-file fields.
