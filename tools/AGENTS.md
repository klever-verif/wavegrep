...
- Helper automation guidance: `../docs/automation.md`
...
- Prefer invoking helpers through `just` recipes or workflow steps; helper paths are implementation detail unless documented here or in `../docs/automation.md`.
