...
- `prepare_mkdocs.py` validates an extracted skill, stages its references for MkDocs under `tmp/docs-site/`, maps `intro.md` to `index.md`, and writes generated MkDocs navigation/config.
