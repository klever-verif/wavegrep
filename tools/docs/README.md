...
- `check_playground.py` checks the composed `/wavepeek/` and `/wavepeek/latest/` preview, compares browser and native behavior, and covers terminal interaction, local-file privacy, worker recovery, theme colors, and responsive layout.
